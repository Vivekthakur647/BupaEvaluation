...
final class UserDefaultTest: XCTestCase {
    ...
    func testSetDarkTheme() {
        UserDefaultsUtils.shared.setDarkMode(enable: true)
        XCTAssertTrue(UserDefaultsUtils.shared.getDarkMode())
//        XCTAssertNotNil(mode)
    }
    func testSetLightTheme() {
        UserDefaultsUtils.shared.setDarkMode(enable: false)
        XCTAssertFalse(UserDefaultsUtils.shared.getDarkMode())
    }
